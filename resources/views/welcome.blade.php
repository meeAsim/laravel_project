...
<script>
    ...
    $(".addBtn").click(function(e){
        ...
        $("#datafield").prepend(`<form class="form" action="{{route('save')}}" method="POST" name="dataForm" id="data" style="display:flex; height:35px;margin-bottom: 10px">
                                ...
                                <td class="form-group"> <br> <input class="form-control" placeholder="Child Address" name="address" id="address" style="margin-right:10px" pattern="[a-zA-Z]*" oninvalid="setCustomValidity('Please enter alphabets only. ')" disabled> </td>
                                <td class="form-group"><br> <input class="form-control" placeholder="Child City" name="city" id="city" style="margin-right:10px" pattern="[a-zA-Z]*" oninvalid="setCustomValidity('Please enter alphabets only. ')" disabled></td>
                                <td class="form-group"><br>  <input class="form-control" placeholder="Child State" name="state"  id="state" style="margin-right:10px" pattern="[a-zA-Z]*" oninvalid="setCustomValidity('Please enter alphabets only. ')" disabled></td>
